...
<header class="header-top">
    <nav class="navbar navbar-light">
        <div class="navbar-left">
            ...
            <a class="navbar-brand" href="#"><img class="dark" src="{{ asset('assets/img/logo_dark.png') }}" alt="svg"><img class="light" src="{{ asset('assets/img/logo_white.png') }}" alt="img"></a>
        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                    ...
                    <div class="dropdown-custom">
                        ...
                        <div class="dropdown-wrapper dropdown-wrapper--large">
                            <ul class="list-settings">
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('assets/img/mail.png') }}" alt=""></div>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('assets/img/color-palette.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('assets/img/home.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('assets/img/video-camera.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('assets/img/document.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('assets/img/microphone.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                ...
                <li class="nav-flag-select">
                    <div class="dropdown-custom">
                        ...
                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            ...
                            <a href="#"><img src="{{ asset('assets/img/ger.png') }}" alt=""> German</a>
                            <a href="#"><img src="{{ asset('assets/img/spa.png') }}" alt=""> Spanish</a>
                            <a href="#"><img src="{{ asset('assets/img/tur.png') }}" alt=""> Turkish</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img src="{{ asset('assets/img/author-nav.jpg') }}" alt="" class="rounded-circle"></a>
                        <div class="dropdown-wrapper">
